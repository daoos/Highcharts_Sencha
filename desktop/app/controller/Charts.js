        ...
        this.control({
            ...
            'chartsTree': {
                itemclick: function (view, model, item) {
                    ...
                    if ('echarts' == chartType) {
                        mainChart = Ext.create('ECharts.ux.ECharts');
                        Ext.getCmp('centerpane').add(mainChart);
                    } else if ('hcharts' == chartType) {
